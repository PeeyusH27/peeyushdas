...
import konwriter from "../assets/peeyush_projects/konwriter.png"
const projects = [
    
    {
      ...
      "technologies": ["NextJs", "TypeScript", "GeminiApi", "TailwindCss", "Clerk", "Drizzle"],
      "links": {
        "web": "https://kon-writer.vercel.app",
